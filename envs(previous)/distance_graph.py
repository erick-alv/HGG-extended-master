...
class DistanceGraph:
    ...
    def plot_goals(self, goals=None, colors=None, azim=-12, elev=15, show=False, save_path='test', extra=None):#JAMES MOD extra=None
    ...
    def plot_graph(self, path=None, graph=False, obstacle_vertices=False, goals=None, save_path='test', show=False, azim=-12, elev=15, extra=None):#JAMES mod
