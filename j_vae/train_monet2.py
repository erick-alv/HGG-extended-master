...
if __name__ == '__main__':
    ...
    parser.add_argument('--beta', help='beta val for the reconstruction loss', type=np.float, default=0.2)##8.)#8.)#5#8
    parser.add_argument('--gamma', help='gamma val for the mask loss', type=np.float, default=1.)###6.)#5.)
