...
for reward_type in ['sparse', 'dense']:
    ...
    register(
        id='FetchSlideMovingObstacle{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchSlideMovingObstacleEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    ...
    register(
        id='FetchPushMovingObstacleEnv{}-v2'.format(suffix),
        entry_point='gym.envs.robotics:FetchPushMovingObstacleEnv2',
        kwargs=kwargs,
        max_episode_steps=100, )
    ...
    register(
        id='FetchPushMovingComEnv{}-v4'.format(suffix),
        entry_point='gym.envs.robotics:FetchPushMovingComEnv4',
        kwargs=kwargs,
        max_episode_steps=100, )

    register(
        id='FetchPushMovingComEnv{}-v6'.format(suffix),
        entry_point='gym.envs.robotics:FetchPushMovingComEnv6',
        kwargs=kwargs,
        max_episode_steps=100, )
