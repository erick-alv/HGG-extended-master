...
MODEL_XML_PATH = os.path.join('fetch', 'push_moving_com6.xml')

class FetchPushMovingComEnv6(fetch_env.FetchEnv, utils.EzPickle):
    ...
    def step(self, action):
        self.move_obstacle()
        return super(FetchPushMovingComEnv6, self).step(action)
    ...
    def _get_obs(self):
        obs = super(FetchPushMovingComEnv6, self)._get_obs()
