...
MODEL_XML_PATH = os.path.join('fetch', 'push_moving_com4.xml')

class FetchPushMovingComEnv4(fetch_env.FetchEnv, utils.EzPickle):
    ...
    def step(self, action):
        self.move_obstacle()
        return super(FetchPushMovingComEnv4, self).step(action)
    ...
    def _get_obs(self):
        obs = super(FetchPushMovingComEnv4, self)._get_obs()
