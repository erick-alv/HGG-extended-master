...
class FetchPushDynEnv(robot_env.RobotEnv, gym.utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        ...
        Args:
            ...
            n_substeps (int): number of substeps the simulation runs on every call to step
             (float): additional height above the table when positioning the gripper
            ...
            direction: initial direction of the slider
        ...
        super(FetchPushDynEnv, self).__init__(
    ...
    def _update_obs(self):
        ...
        obj_qpos = self.sim.data.get_joint_qpos('keeper0:joint')
        if obj_qpos > 0.25 or obj_qpos < -0.25:
            self.direction *= -1
    ...
    def render(self, mode='human', width=500, height=500):
        return super(FetchPushDynEnv, self).render(mode, width, height)
