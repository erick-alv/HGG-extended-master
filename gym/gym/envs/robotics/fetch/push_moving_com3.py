...
MODEL_XML_PATH = os.path.join('fetch', 'push_moving_com3.xml')

class FetchPushMovingComEnv3(fetch_env.FetchEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        ...
        #for moving
        self.vel_lims = [0.52, 0.725]
        self.current_obstacle_vel = 0.52
    ...
    def step(self, action):
        self.move_obstacle()
        return super(FetchPushMovingComEnv3, self).step(action)
    ...
    def _get_obs(self):
        obs = super(FetchPushMovingComEnv3, self)._get_obs()
