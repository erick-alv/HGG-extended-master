...
MODEL_XML_PATH = os.path.join('fetch', 'push_moving_com.xml')

class FetchPushMovingComEnv(fetch_env.FetchEnv, utils.EzPickle):
    ...
    def step(self, action):
        self.move_obstacle()
        return super(FetchPushMovingComEnv, self).step(action)
