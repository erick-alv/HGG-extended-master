...
def clip_return_range(args):
	...
	return {
		...
		'FetchPushMovingObstacleEnv-v1': (-gamma_sum, 0.0),
		'FetchPushMovingDoubleObstacleEnv-v1': (-gamma_sum, 0.0),
		'FetchTwinkleObstacleEnv-v1':(-gamma_sum, 0.0),
		'FetchPushMovingComEnv-v1':(-gamma_sum, 0.0),
		'FetchGenerativeEnv-v1': (-gamma_sum, 0.0),
